...
function InfoUser({show, userProfile, deleteUser}) {
  ...
  return (
    ...
    <div className="table-container">
      <h3>Ciao {localUserProfile.name}</h3>
      <table className="table">
        ...
        <tbody>
          {
            <tr>
              <td>{localUserProfile.name} {localUserProfile.surname}</td>
              <td>{localUserProfile.email}</td>              
              <td><img src={localUserProfile.avatar} alt='Avatar'></img></td>
