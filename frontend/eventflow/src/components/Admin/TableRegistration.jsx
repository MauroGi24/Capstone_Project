...
const TableRegistration = ({registrations, onEditRegistration, deleteRegistration}) => {
        ...
        <tbody>
          {registrations.map((registration, index) => (
            <tr key={registration._id}>
              ...
              <td>{new Date(registration.eventId?.date).toLocaleDateString('it-IT')}</td>  {/* Formattazione della data */}
